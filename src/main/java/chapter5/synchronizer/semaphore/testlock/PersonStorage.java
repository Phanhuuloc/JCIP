package chapter5.synchronizer.semaphore.testlock;
...
public class PersonStorage {
     ...
     *
     * @param person the instance of {@link Person} to be inserted
     ...
     *
     * @param id the id representing the location of the object within the map
